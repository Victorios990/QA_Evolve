...
public class ConfigManager {
    ...
    public String getIGameBaseUrl()   { return get("igaming.base.url"); }
    ...
    public String getIGameUser()      { return get("igaming.user"); }
    public String getIGamePassword()  { return get("igaming.password"); }
    public String getIGameAdminUser() { return get("igaming.admin.user"); }
    public String getIGameAdminPass() { return get("igaming.admin.password"); }
}
